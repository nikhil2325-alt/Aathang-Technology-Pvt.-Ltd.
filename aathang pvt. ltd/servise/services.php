...
<!-- 2 Professional summary -->
      <h5 style="color:#ff0080; margin-top:30px; font-family:'Adamina',serif;">Professional Summary</h5>
      <hr style="border-color:#0ff;">
      <img src="../image/p8.jpg" alt="EPLAN Pro Panel" style="max-width:100%; height:auto; display:block; margin-bottom:15px;">
      <p style="color:#fff;">
        <strong>An Electrical Design Engineer having professional experience in developing,</strong> designing machine
              automation, automated manufacturing system and controlling engineering systems.
      </p>
      <p style="color:#fff;">
        Competency in
              Automotive, Conveyors, Material handling, Assembly Line, Robots, Gantry, Welding Fixtures etc.
      </p>
      <p style="color:#fff;">
        applications using E-plan Electric, Fluid & AutoCAD software across multiple automation systems and
              technologies.
            </p>
      
         
 <!-- 3 work-->
  <h5 style="color:#ff0080; margin-top:30px; font-family:'Adamina',serif;">work</h5>
      <hr style="border-color:#0ff;">
      <img src="../image/nn6.jpeg" alt="EPLAN Pro Panel" style="max-width:100%; height:auto; display:block; margin-bottom:15px;">
      <p style="color:#fff;">
        Control System Designing for Automotive, Conveyors, Material handling & Welding fixtures.</p>
      <p style="color:#fff;">
       ● Design & preparation of Electrical circuit using E-plan P8
                Electric & AutoCAD Electric in automotive domain.<br>
                ● Design & preparation of Fluid circuit (Pneumatic, Hydraulic, Lubrication) using E-plan P8 & AutoCAD
                <br>
                ● Draft and design the general assembly (GA), panel layouts, network and power architecture, single line
                diagram (SLD) of entire system as per the standards<br>
                ● Understanding circuits for pneumatic, hydraulic, lubrication and coolant supply.<br>
                ● Selection of Switchgear item, Enclosures, Main disconnect, Cables, Bill of Material (BOM).<br>
                ● Selection of Fluid component of pneumatic, hydraulic, lubrication.<br>
                ● Decide or suggest the components and equipment according to the standards and specifications to
                customer.<br>
                ● Perform heat calculation, load calculations, pneumatic air flow calculation.<br>
                ● Designing Control Panel, selection of panel components & machine components.<br>
                ● Panel designing using special macro project in E-plan.<br>
                ● IO list preparation.<br>
                ● IP addressing as per customer standards.<br>
                ● Report Generation in E-plan<br>
              </p>

 <!-- 4 why we choose us? -->
      <h5 style="color:#ff0080; margin-top:30px; font-family:'Adamina',serif;">Why Choose Athang Technology?</h5>
      <hr style="border-color:#0ff;">
      
      <p><strong>Expertise in EPLAN, AutoCAD Electrical & SolidEdge Electrical</strong></p>
              <p> <strong>Highly accurate and standards-based electricaldocumentation</strong></p>
              <p> <strong>Quick turnaround and responsive support</strong></p>
              <p> <strong>Custom design solutions for automation systems</strong></p>
              <p> <strong>Cost-effective and scalable service model</strong></p>
