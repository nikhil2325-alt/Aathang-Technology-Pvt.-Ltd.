...
<div class="container-fluid" style="padding:20px;">
  <div class="row">
    <div class="col-lg-8 col-sm-12">
      <h3 style="color:#ff0080; font-family:'Adamina',serif;">System Integration</h3>
      <hr style="border-color:#0ff;">
      <img src="../image/nn3.jpg" alt="System Integration" style="max-width:100%; height:auto; display:block; margin-bottom:15px;">
      <strong>System Integration – Unified Automation for Smarter Operations</strong>

      <p style="color:#fff;">System Integration is the process of connecting different engineering systems, software platforms, and hardware components into one unified and intelligent workflow. It ensures that all subsystems—such as electrical, automation, PLCs, HMIs, SCADA, ERP, and field devices—communicate seamlessly with each other to perform as a single cohesive unit.</p>

      <p style="color:#fff;">At our core, we specialize in designing and implementing tailored system integration solutions that bridge the gap between operations and IT. Whether it's integrating EPLAN Electric P8 and EPLAN Pro Panel with ERP systems, connecting PLCs with SCADA interfaces, or establishing communication between field devices and cloud platforms, our integration strategies are secure, scalable, and future-ready.</p>

      <p style="color:#fff;">Through structured and intelligent integration, we enable smart decision-making, remote monitoring, predictive maintenance, and improved productivity—laying the foundation for Industry 4.0 and digital transformation.</p>

      <h5 style="color:#ff0080; margin-top:30px; font-family:'Adamina',serif;">Our Approach to System Integration</h5>
      <hr style="border-color:#0ff;">
      <p style="color:#fff;">
        <strong>We don’t believe in one-size-fits-all. Every plant, machine, and operation is unique—so our integration solutions are customized to meet your exact workflow requirements.</strong>
      </p>
      <ul style="color:#fff;">
        <li>Integrating your EPLAN designs with your ERP systems</li>
        <li>Connecting PLCs to your SCADA or HMI platforms</li>
        <li>Setting up real-time monitoring dashboards</li>
        <li>Linking legacy systems with modern IoT platforms</li>
      </ul>
    </div>
    ...
    <div class="col-lg-4 col-sm-12">
      ...
      <div style="background:#111; border-radius:12px; padding:20px; margin-bottom:20px; box-shadow:0 0 20px rgba(0,255,255,0.3);">
        ...
        <p style="color:#0ff; cursor:pointer;" onclick="goTo('Processing.php')">&#9656; Food & Beverage Processing</p>
